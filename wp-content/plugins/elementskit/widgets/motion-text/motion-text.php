...
class Elementskit_Widget_Motion_Text extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'char_based' => esc_html__( 'Char Based', 'elementskit' ),
				],
				'condition' => [
    ...
    protected function render_raw( ) {
		...
		<div class="elementskit_motion_text_wraper">
			...
			<?php
				echo '<' .$settings['ekit_motion_text_sub_title_tag']. ' class="ekit_motion_text_title '.$motion_main_class.' '.$anim_motion_class.' '.$ekit_text_spilit_class.' '.$ekit_text_spilit_one_by_one_class.'">';
				if ($url !== '') {
					echo '<a href='.$url.' target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'"><span class="ekit_motion_text" data-ekit-animation-delay="'.esc_attr($animation_delay_char_based).'">'.esc_html( $title_text ).'</span></a>';
				} else {
					echo '<span class="ekit_motion_text" data-ekit-animation-delay="'.esc_attr($animation_delay_char_based).'">'.esc_html( $title_text ).'</span>';
				} ?>
