...
class Elementskit_Widget_Pricing extends Widget_Base {
    ...
    protected function render_raw( ) {
		...
		if ( ! empty( $settings['ekit_pricing_icon'] ) ) {
            $this->add_render_attribute( 'icon', 'class', $settings['ekit_pricing_icon'].' elementkit-pricing-icon'.' elementor-animation-'.$settings['ekit_pricing_icons_hover_animation']);
        ...
        <div class="elementskit-single-pricing <?php echo $settings['ekit_pricing_order_enable'] == 'yes' ? 'd-flex flex-column' : ''; ?>" >
            <div class="elementskit-pricing-header <?php echo $header_order ? 'order-'.esc_html( $header_order ) : ''; ?>">
            ...
            <div class=" elementskit-pricing-price-wraper has-tag <?php echo $price_order ? 'order-'.esc_html( $price_order ) : ''; ?>">
            ...
            <div class="elementskit-pricing-content <?php echo $features_order ? 'order-'.esc_html( $features_order ) : ''; ?>">
                ...
                <?php if($content_style == 'list'){ ?>
                    <ul class="elementskit-pricing-lists">
                        <?php  foreach($table_content_repeater as $repeat){  ?>
                            <li class="elementor-repeater-item-<?php echo esc_attr( $repeat[ '_id' ] ); ?>"><i class="<?php echo esc_attr($repeat['ekit_pricing_check_icon']);?>"></i><?php echo esc_html($repeat['ekit_pricing_list']); ?></li>
                        <?php } ?>
                    </ul>
                <?php } ?>
            </div>
            <div class="elementskit-pricing-btn-wraper <?php echo $button_order ? 'order-'.esc_html( $button_order ) : ''; ?>">
				<?php if ( $btn_text ): ?>
				<a href="<?php echo esc_url( $btn_link ); ?>" class="elementskit-pricing-btn <?php echo esc_attr( $btn_class ); ?>" id="<?php echo esc_attr( $btn_id ); ?>">
					<?php
					if ( $settings['ekit_pricing_btn_icon'] != '' && $icon_align == 'left' ):
						?>
						<i class="<?php echo esc_attr( $settings['ekit_pricing_btn_icon'] ); ?>"></i>
						<?php
					endif;

					echo esc_html( $btn_text );
					
					if ( $settings['ekit_pricing_btn_icon'] != '' && $icon_align == 'right' ):
						?>
						<i class="<?php echo esc_attr( $settings['ekit_pricing_btn_icon'] ); ?>"></i>
						<?php
					endif;
