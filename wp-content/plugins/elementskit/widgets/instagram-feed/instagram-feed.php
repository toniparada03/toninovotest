...
class Elementskit_Widget_Instagram_Feed extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .layout-grid .ekit-insta-col-4' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
	...
	?>
		...
		<div class="ekit-instagram-area">
			<div class="ekit-insta-row <?php echo esc_attr($masnory_column.' '.$styleLayout); ?>">
				<?php
