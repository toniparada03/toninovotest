            ...
            <?php  if($xs_query->have_posts()): ?>
                <?php while ($xs_query->have_posts()) : ?>
                    ...
                    <?php if(has_post_thumbnail()): ?>
                        <div class="tab__post__single--item <?php echo esc_attr($count_col); ?> post-count-<?php echo esc_attr($post_count); ?>">
                            <a href="<?php echo get_the_permalink(); ?>" class="tab__post--header">
                                <?php $img_url = get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>
                                <div class="post_grid_img_thumb" style="background-image: url('<?php echo $img_url; ?>')"></div>
