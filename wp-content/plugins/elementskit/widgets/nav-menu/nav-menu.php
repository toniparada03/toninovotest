...
class Elementskit_Widget_Nav_Menu extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		// 	[
		// 		'label' => __( 'Mega Menu Panel Width', 'plugin-domain' ),
		// 		'type' => Controls_Manager::SELECT,
		// 		'default' => 'fited',
		// 		'options' => [
		// 			'full_width'  => __( 'Full Width', 'plugin-domain' ),
		// 			'fited' => __( 'Fit to', 'plugin-domain' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Menu Icon Padding', 'elementskit' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Indicator Margin', 'elementskit' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sub Menu Items Border', 'elementskit' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border Last Child', 'elementskit' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border First Child', 'elementskit' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'elementskit_submenu_container_spacing',
			[
				'label' => __( 'Padding', 'elementskit' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				...
				'selectors' => [
					'{{WRAPPER}} .elementskit-navbar-nav .elementskit-submenu-panel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
