...
class Elementskit_Widget_Woo_Mini_Cart extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
			...
			[
				'label' => __( 'Cart Button', 'elementskit' ),
    ...
    protected function render_raw(){
        ...
        <div class="ekit-mini-cart">
            <div href="#" class="ekit-dropdown-back ekit-mini-cart-visibility-<?php echo esc_attr( $settings['ekit_woo_mini_cart_visibility'] ); ?>" data-toggle="dropdown">
                <i class="<?php echo $settings['ekit_woo_mini_cart_icon'];?>" aria-hidden="true"></i>
                ...
                <div class="ekit-mini-cart-container">
                    <div class="mini-cart-header">
                        <ul>
                            <li><?php echo (( WC()->cart != '' ) )?  WC()->cart->get_cart_contents_count() : '' ; ?> <?php esc_html_e( 'items', 'elementskit' ); ?></li>
