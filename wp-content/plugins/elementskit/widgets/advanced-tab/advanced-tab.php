...
class Elementskit_Widget_Advanced_Tab extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Keep open this tab? ', 'elementskit'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
        ...
        <div class="elementkit-tab-wraper <?php echo esc_attr($ekit_tab_style == 'vertical' ? 'vertical' : ''); ?> <?php if ($ekit_tab_fill_full_width != 'yes') : ?> elementskit-fitcontent-tab <?php endif; ?>">
            <ul class="<?php echo esc_attr($nav_wrapper_class); ?>" role="tablist">
                <?php foreach ($ekit_tab_items as $i=>$tab) :
                    ...
                    $icon_html = (isset($tab['ekit_tab_title_icon_type']) && $tab['ekit_tab_title_icon_type'] == 'icon' && $tab['ekit_tab_title_icon'] != '') ?
                        '<span class="'.$tab['ekit_tab_title_icon'].' elementskit-tab-icon"></span>' : '';
                    ...
                    <li class="elementkit-nav-item elementor-repeater-item-<?php echo esc_attr( $tab[ '_id' ] ); ?>">
                        <a class="elementkit-nav-link <?php echo esc_attr($is_active);?> <?php echo esc_attr($ekit_tab_header_icon_pos_style); ?>" id="content-<?php echo esc_attr($tab['_id'].$tab_id); ?>-tab" data-ekit-toggle="tab" href="#content-<?php echo esc_attr($tab['_id'].$tab_id); ?>"
                           role="tab" aria-controls="content-<?php echo esc_attr($tab['_id'].$tab_id); ?>" aria-selected="true">
                            <?php echo \ElementsKit\Utils::kses($icon_html.$img_html); ?>
