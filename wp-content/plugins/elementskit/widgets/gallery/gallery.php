...
class Elementskit_Widget_Gallery extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementskit-single-portfolio-item .elementskit-gallery-icon' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementskit-single-portfolio-item:hover .elementskit-gallery-icon' => 'opacity: {{SIZE}};',
                ],
            ]
        );
    ...
    ?>
        ...
        ?>
        <?php if(count($ekit_gallery_items) > 1): ?>
            ...
            foreach( $item['ekit_gallery_filter_images'] as $img ):
                ...
                <div class="ekit_gallery_grid_item <?php echo esc_attr($this->clean_class($item['ekit_gallery_filter_label']).' '.$gallery_grid_class); ?>">
                    ...
                    >
                        ...
                        <?php endif; ?>
                        >
                        <img class="elementskit-grid__img" src="<?php echo esc_url( $img[ 'url' ] ); ?>" <?php if($metadata['alt'] != '') : ?> alt="<?php echo $metadata['alt']; ?>"<?php endif; ?>/>
                        </div>
                        <div class="elementskit-hover-area">
                            <div class="elementskit-hover-content ekit_vertical_alignment_<?php echo esc_attr($ekit_gallery_content_vertical_alignment); ?>">
                                ...
                                ?>
                                <?php if(($ekit_gallery_open_lightbox == 'yes') && ($ekit_gallery_link_icon != '')): ?>
                                <div class="elementskit-gallery-popup-icon-wraper">
                                    ...
                                    <?php endif; ?>
                                        >
                                        <i class="icon <?php echo esc_attr($ekit_gallery_link_icon); ?>"></i>
                                    </a>
                                </div>
                                <?php endif; ?>
                            </div>
