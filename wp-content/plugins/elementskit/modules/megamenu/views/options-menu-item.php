        ...
        <div class="attr-modal-content ekit_menu_modal_content">
            <div class="attr-modal-header">
                <ul class="tb-nav tb-nav-tabs ekit_menu_control_nav" role="tablist">
                    ...
                    <li role="presentation" id="attr_icon_nav"><a class="attr-nav-link" href="#attr_icon_tab" aria-controls="attr_icon_tab" role="tab"
                            data-attr-toggle="tab"><?php esc_html_e('Icon', 'elementskit'); ?></a></li>
                    <li role="presentation" id="attr_badge_nav"><a class="attr-nav-link" href="#attr_badge_tab" aria-controls="attr_badge_tab"
