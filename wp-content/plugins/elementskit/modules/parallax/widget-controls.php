...
class ElementsKit_Widget_Effect_Controls{
    ...
    public function register_controls($control, $args)
    {
        $control->start_controls_section(
            'ekit_widget_effects',
            [
                'label' => esc_html__('ElementsKit Effects', 'parallax'),
        ...
        */
        $control->add_control(
            ...
            [
                'label' => esc_html__('CSS Animation', 'prefix'),
        ...
        $control->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    "{{WRAPPER}}" => '-webkit-animation-name:{{UNIT}}',
                    "{{WRAPPER}}" => 'animation-name:{{UNIT}}',
                ],
            ]
        );
        ...
        $control->add_control(
            ...
            [
                ...
                'selectors' => [
                    "{{WRAPPER}}" => '-webkit-animation-duration:{{UNIT}}s',
                    "{{WRAPPER}}" => 'animation-duration:{{UNIT}}s'
                ],
            ]
        );
        $control->add_control(
            ...
            [
                ...
                'selectors' => [
                    "{{WRAPPER}}" => 'animation-iteration-count:{{UNIT}}'
                ],
            ]
        );
        $control->add_control(
            ...
            [
                ...
                'selectors' => [
                    "{{WRAPPER}}" => 'animation-direction:{{UNIT}}'
                ],
            ]
        );
        ...
        */
        $control->add_control(
            ...
            [
                'label' => __( 'CSS Transform', 'elementskit' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'condition' => [
        ...
        $control->add_control(
            ...
            [
                'label' => __( 'Translate', 'elementskit' ),
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => __( 'Translate X', 'elementskit' ),
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => __( 'Translate Y', 'elementskit' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
        ...
        */
        ...
        $control->add_control(
            ...
            [
                'render_type' => 'none',
                'frontend_available' => true,
                'label' => esc_html__('Disable animation in editor ', 'prefix'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'on',
                'label_on' => esc_html__('On', 'elemenetskit'),
                'label_off' => esc_html__('Off', 'elemenetskit'),
