...
+function ($) {
  ...
  Alert.prototype.close = function (e) {
    ...
    $.support.transition && $parent.hasClass('attr-fade') ?
      $parent
...
+function ($) {
  ...
  var Collapse = function (element, options) {
    ...
    this.$trigger      = $('[data-attr-toggle="collapse"][href="#' + element.id + '"],' +
                           '[data-attr-toggle="collapse"][data-target="#' + element.id + '"]')
  ...
  Collapse.prototype.show = function () {
    ...
    this.$element
      .removeClass('attr-collapse')
      .addClass('attr-collapsing')[dimension](0)
      .attr('aria-expanded', true)

    this.$trigger
      .removeClass('attr-collapsed')
      .attr('aria-expanded', true)
    ...
    var complete = function () {
      this.$element
        .removeClass('attr-collapsing')
        .addClass('attr-collapse attr-in')[dimension]('')
      this.transitioning = 0
      this.$element
        .trigger('shown.bs.attr-collapse')
    }
  ...
  Collapse.prototype.hide = function () {
    ...
    this.$element
      .addClass('attr-collapsing')
      .removeClass('attr-collapse attr-in')
      .attr('aria-expanded', false)

    this.$trigger
      .addClass('attr-collapsed')
      .attr('aria-expanded', false)
  ...
  Collapse.prototype.addAriaAndCollapsedClass = function ($element, $trigger) {
    ...
    $trigger
      .toggleClass('attr-collapsed', !isOpen)
    ...
    if (!isActive) {
      if ('ontouchstart' in document.documentElement && !$parent.closest('.attr-navbar-nav').length) {
        ...
        $(document.createElement('div'))
          .addClass('attr-dropdown-backdrop')
          .insertAfter($(this))
          .on('click', clearMenus)
      }
...
+function ($) {
  ...
  Modal.prototype.hide = function (e) {
    ...
    $.support.transition && this.$element.hasClass('attr-fade') ?
      this.$element
  ...
  $(document).on('click.bs.modal.data-api', '[data-attr-toggle="modal"]', function (e) {
    ...
    var option  = $target.data('bs.attr-modal') ? 'toggle' : $.extend({ remote: !/#/.test(href) && href }, $target.data(), $this.data())
...
+function ($) {
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      $.support.transition && this.$tip.hasClass('attr-fade') ?
        $tip
  ...
  Tooltip.prototype.hide = function (callback) {
    ...
    $.support.transition && $tip.hasClass('attr-fade') ?
      $tip
        .one('bsTransitionEnd', complete)
        .emulateTransitionEnd(Tooltip.TRANSITION_DURATION) :
      complete()
...
+function ($) {
  ...
  Popover.prototype.setContent = function () {
    ...
    $tip.removeClass('attr-fade attr-top attr-bottom attr-left attr-right attr-in')
...
+function ($) {
  ...
  Tab.prototype.activate = function (element, container, callback) {
    ...
    var transition = callback
      && $.support.transition
      && ($active.length && $active.hasClass('attr-fade') || !!container.find('> .attr-fade').length)

    function next() {
      $active
        .removeClass('attr-active')
        .find('> .attr-dropdown-menu > .attr-active')
          .removeClass('attr-active')
        .end()
        .find('[data-attr-toggle="tab"]')
          .attr('aria-expanded', false)
  ...
  $(document)
    .on('click.bs.tab.data-api', '[data-attr-toggle="tab"]', clickHandler)
    .on('click.bs.tab.data-api', '[data-attr-toggle="pill"]', clickHandler)
